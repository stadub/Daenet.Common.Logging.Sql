...
namespace Daenet.Common.Logging.Sql
{
    ...
    public static class SqlServerLogProviderExtensions
    {
        ...
        {
            builder.Services.AddSingleton<ISqlBatchLogTask, SqlServerBatchLogTask> ();
        ...
        public static ILoggingBuilder AddSqlServerLogger(this ILoggingBuilder builder, Action<SqlLoggerSettings> configure)
        {
            if (configure == null)
            {
        ...
        {
            var logger = new SqlServerBatchLogTask(settings);
